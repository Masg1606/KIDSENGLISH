 ...
 * animales
 */
public class ControladorAnimals3 implements Initializable {
    ...
    @FXML
    public void Duck(ActionEvent event) {
        try {
            JOptionPane.showMessageDialog(null, "Sorry! Try Again");
            Parent root = FXMLLoader.load(getClass().getResource("/Vistas/PantallaPrincipal.fxml"));
            Scene scene = new Scene(root);
    ...
    @FXML
    public void Eagle(ActionEvent event) {
        try {
                        JOptionPane.showMessageDialog(null, "Congratulations! Well done!");
            Parent root = FXMLLoader.load(getClass().getResource("/Vistas/Animals_4.fxml"));
            Scene scene = new Scene(root);
            Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            stage.setScene(scene);
            stage.show();
