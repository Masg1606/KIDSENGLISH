 ...
 * animales
 */
public class ControladorAnimals2 implements Initializable {
     ...
     */
    @FXML
    public void Ant(ActionEvent event) {
        try {
    ...
    @FXML
    public void Cricket(ActionEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/Vistas/PantallaPrincipal.fxml"));
            Scene scene = new Scene(root);
            Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
    ...
    @FXML
    public void Bee(ActionEvent event) {
        try {
                        JOptionPane.showMessageDialog(null, "Congratulations! Well done!");
            Parent root = FXMLLoader.load(getClass().getResource("/Vistas/Animals_3.fxml"));
            Scene scene = new Scene(root);
            Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            stage.setScene(scene);
            stage.show();
